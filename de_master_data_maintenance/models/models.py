...
class ProductTemplate(models.Model):
    ...
    parent_product_tmpl_id = fields.Many2one('product.template', 'Parent Product ', store=True, required=False)
    ref_product_tmpl_id = fields.Many2one('product.template', 'Reference Product', store=True, required=False)
...
class ProductDataMaintenance(models.Model):
    ...
    routing_id = fields.Many2one('mrp.routing', string='Routing', ondelete='setnull', required=False)
