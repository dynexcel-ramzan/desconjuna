...
class AccountInvoice(models.Model):
    ...
    amt_words = fields.Char(string='Amount in Word', compute='_compute_amt_in_word')
    ...
    def _compute_amt_in_word(self):
        for rec in self:
            word = rec.amount_to_text(rec.amount_total)
            amount_word = word + ' Only'
            rec.amt_words = amount_word
